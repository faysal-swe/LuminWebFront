...
const ProductDetails = () => {
  return (
    <div className="container mx-auto mt-8 flex flex-col md:flex-row md:items-center">
      ...
      <h2 className="text-2xl font-bold text-center mb-4 bg-green-500 text-white p-2 mx-10">Sweater Yarn</h2>
      ...
      <div className="flex-1">
        <img src="Product10ss.PNG" alt="Product" className="w-full" />
      </div>
    </div>
  );
};
